...
const comparisonsEN = [
  ...
  },
  {
    ...
    description: 'Compare ReplyStack and Guest Suite for customer review management. Features, AI responses, pricing and detailed verdict.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Transparent pricing vs Quote-based',
  },
  {
    ...
    description: 'Compare ReplyStack and SoLike for AI review responses. Chrome extensions, features, pricing for hotels and businesses.',
    date: '2026-01-15',
    readingTime: 12,
    highlight: 'Multi-industry vs Hospitality focus',
  },
  {
    ...
    description: 'Compare ReplyStack and Custplace for review management. Features, pricing and verdict for businesses seeking reputation solutions.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'SMB-friendly vs Enterprise focus',
  },
  {
    ...
    description: 'Compare ReplyStack and Revi for review management. Features, pricing and verdict for e-commerce and local businesses.',
    date: '2026-01-15',
    readingTime: 12,
    highlight: 'External reviews vs E-commerce',
  },
];
...
const comparisonsFR = [
  ...
  },
  {
    ...
    competitorLogo: '🏆',
    title: 'ReplyStack vs Podium',
    description: 'Découvrez les différences entre ReplyStack et Podium. Fonctionnalités, prix, avantages et inconvénients comparés.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Extension Chrome vs Dashboard',
  },
  {
    slug: 'replystack-vs-talkbackai',
    competitor: 'TalkbackAI',
    competitorLogo: '💬',
    title: 'ReplyStack vs TalkbackAI',
    description: 'Comparez ReplyStack et TalkbackAI pour la génération de réponses aux avis. Extensions Chrome, IA et prix.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Extension + Dashboard vs Extension seule',
  },
  {
    slug: 'replystack-vs-nicejob',
    competitor: 'NiceJob',
    competitorLogo: '⭐',
    title: 'ReplyStack vs NiceJob',
    description: 'Comparez ReplyStack et NiceJob pour la gestion des avis. Collecte, réponses IA, automatisation et prix détaillés.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Réponse vs Collecte d\'avis',
  },
  {
    slug: 'replystack-vs-guest-suite',
    competitor: 'Guest Suite',
  ...
  },
  {
    ...
    competitorLogo: '🛒',
    title: 'ReplyStack vs Revi',
    description: 'Comparez ReplyStack et Revi pour la gestion des avis. Fonctionnalités, réponses IA, tarifs et verdict détaillé.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Réponse vs E-commerce',
  },
];
...
const comparisonsES = [
  ...
  },
  {
    ...
    competitorLogo: '💬',
    title: 'ReplyStack vs TalkbackAI',
    description: 'Compara ReplyStack y TalkbackAI para generar respuestas a reseñas. Extensiones Chrome, funciones IA y precios.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Extensión + Dashboard vs Extensión sola',
  },
  {
    slug: 'replystack-vs-nicejob',
    competitor: 'NiceJob',
    competitorLogo: '⭐',
    title: 'ReplyStack vs NiceJob',
    description: 'Compara ReplyStack y NiceJob para la gestión de reseñas. Recolección, respuestas IA y precios detallados.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Respuesta vs Recolección',
  },
  {
    slug: 'replystack-vs-guest-suite',
    competitor: 'Guest Suite',
    competitorLogo: '🏨',
    title: 'ReplyStack vs Guest Suite',
    description: 'Compara ReplyStack y Guest Suite para gestión de reseñas. Funcionalidades, precios y veredicto detallado.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Precio transparente vs Presupuesto',
  },
  {
    slug: 'replystack-vs-solike',
    competitor: 'SoLike',
    competitorLogo: '💬',
    title: 'ReplyStack vs SoLike',
    description: 'Compara ReplyStack y SoLike para respuestas IA a reseñas. Precios y veredicto para hoteles y negocios.',
    date: '2026-01-15',
    readingTime: 12,
    highlight: 'Multi-sector vs Hostelería',
  },
  {
    slug: 'replystack-vs-revi',
    competitor: 'Revi',
  ...
  },
  {
    ...
    competitorLogo: '🏢',
    title: 'ReplyStack vs Custplace',
    description: 'Compara ReplyStack y Custplace para gestión de reseñas. Funcionalidades, precios y veredicto para empresas.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'PYME vs Enterprise',
  },
];
...
const comparisonsPT = [
  ...
  },
  {
    ...
    competitorLogo: '💬',
    title: 'ReplyStack vs TalkbackAI',
    description: 'Compare ReplyStack e TalkbackAI para gerar respostas a avaliações. Extensões Chrome, IA e preços.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Extensão + Dashboard vs Extensão só',
  },
  {
    slug: 'replystack-vs-nicejob',
    competitor: 'NiceJob',
    competitorLogo: '⭐',
    title: 'ReplyStack vs NiceJob',
    description: 'Compare ReplyStack e NiceJob para gestão de avaliações. Coleta, respostas IA e preços detalhados.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Resposta vs Coleta',
  },
  {
    slug: 'replystack-vs-guest-suite',
    competitor: 'Guest Suite',
    competitorLogo: '🏨',
    title: 'ReplyStack vs Guest Suite',
    description: 'Compare ReplyStack e Guest Suite para gestão de avaliações. Funcionalidades, preços e veredito detalhado.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'Preço transparente vs Orçamento',
  },
  {
    slug: 'replystack-vs-solike',
    competitor: 'SoLike',
    competitorLogo: '💬',
    title: 'ReplyStack vs SoLike',
    description: 'Compare ReplyStack e SoLike para respostas IA a avaliações. Extensões Chrome, preços e veredito para hotéis e negócios.',
    date: '2026-01-15',
    readingTime: 12,
    highlight: 'Multi-setor vs Hotelaria',
  },
  {
    slug: 'replystack-vs-custplace',
    competitor: 'Custplace',
    competitorLogo: '🏢',
    title: 'ReplyStack vs Custplace',
    description: 'Compare ReplyStack e Custplace para gestão de avaliações. Funcionalidades, preços e veredito para empresas.',
    date: '2026-01-15',
    readingTime: 14,
    highlight: 'PME vs Enterprise',
  },
  {
    slug: 'replystack-vs-revi',
    competitor: 'Revi',
    competitorLogo: '🛒',
    title: 'ReplyStack vs Revi',
    description: 'Compare ReplyStack e Revi para gestão de avaliações. Funcionalidades, preços e veredito para e-commerce e negócios locais.',
    date: '2026-01-15',
    readingTime: 12,
    highlight: 'Avaliações externas vs E-commerce',
  },
];
