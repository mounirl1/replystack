...
class ResponseProfileController extends Controller
{
    ...
    public function store(Request $request, Location $location): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'include_elements' => ['sometimes', 'array'],
            'include_elements.negative' => ['sometimes', 'array'],
            'include_elements.negative.customer_name' => ['sometimes', 'boolean'],
            'include_elements.negative.business_name' => ['sometimes', 'boolean'],
            'include_elements.negative.emojis' => ['sometimes', 'boolean'],
            'include_elements.negative.invitation' => ['sometimes', 'boolean'],
            'include_elements.negative.signature' => ['sometimes', 'boolean'],
            'include_elements.neutral' => ['sometimes', 'array'],
            'include_elements.neutral.customer_name' => ['sometimes', 'boolean'],
            'include_elements.neutral.business_name' => ['sometimes', 'boolean'],
            'include_elements.neutral.emojis' => ['sometimes', 'boolean'],
            'include_elements.neutral.invitation' => ['sometimes', 'boolean'],
            'include_elements.neutral.signature' => ['sometimes', 'boolean'],
            'include_elements.positive' => ['sometimes', 'array'],
            'include_elements.positive.customer_name' => ['sometimes', 'boolean'],
            'include_elements.positive.business_name' => ['sometimes', 'boolean'],
            'include_elements.positive.emojis' => ['sometimes', 'boolean'],
            'include_elements.positive.invitation' => ['sometimes', 'boolean'],
            'include_elements.positive.signature' => ['sometimes', 'boolean'],
